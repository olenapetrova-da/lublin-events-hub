...
$zoomEnrichUrl = "$ZOOM?date=$DATE&$BASE&enrich=1&enrich_max=10"
...
$officialEnrichUrl = "$OFFICIAL?date=$DATE&$BASE&enrich=1&enrich_max=10"
$officialEnrich = Get-Json $lublinEnrichUrl
